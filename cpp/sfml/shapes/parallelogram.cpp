...
int main() {
  ...
  shape.setPoint(0, {-width/2 - offset,  height/2});
  shape.setPoint(1, {-width/2 + offset, -height/2});
  shape.setPoint(2, { width/2 + offset, -height/2});
  shape.setPoint(3, { width/2 - offset,  height/2});
